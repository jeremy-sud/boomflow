    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-950">
      <div className="max-w-md w-full mx-4">
        ...
        <div className="bg-zinc-900/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
          <h2 className="text-xl font-semibold text-center mb-6">Inicia Sesión</h2>
        ...
        <div className="mt-8 text-center text-sm text-zinc-600">
          <p>Al iniciar sesión, aceptas los términos de uso de BOOMFLOW</p>
          <p className="mt-2">
            ¿No tienes acceso?{" "}
